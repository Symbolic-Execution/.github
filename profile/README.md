...
part of the native application model on Ethereum, not just an external service,
rollup or isolated tool creating fragmented liquidity.
...
with, and easier to plug into existing sources of liquidity, like Ethereum
mainnet.
